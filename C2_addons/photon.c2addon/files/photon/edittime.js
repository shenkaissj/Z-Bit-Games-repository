...
AddStringParam("Room", "Room name.");
AddNumberParam("RejoinActorNr", "Actor number to rejoin");
...
AddComboParamOption("SqlLobby", "This lobby type lists rooms like Default but JoinRandom has a parameter for SQL-like 'where' clauses for filtering. This allows bigger, less, or and and combinations.");
AddComboParam("LobbyType", "Lobby type.");
AddAction(12, af_none, "Join room", "Lobby", "Join room <b>{0}</b> in lobby <b>{3}</b>/<b>{4}</b> (create if not exists: <b>{2}</b>, rejoin as <b>{1}</b>)", "Join room.", "joinRoom");
AddComboParamOption("No");
AddComboParamOption("Yes");
...
AddAction(110, af_none, "Set unique userid check", "Room", "Set user id check to to <b>{0}</b>", "Activates user id checks on joining if set to true.", "setUniqueUserId");
